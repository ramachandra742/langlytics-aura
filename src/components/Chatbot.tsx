    ...
    <>
      ...
      {!isOpen && (
        <Button
          ...
          className="fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full glow-primary shadow-2xl"
          size="icon"
        >
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className={`fixed bottom-6 right-6 z-50 w-80 bg-card border border-border rounded-2xl shadow-2xl transition-all duration-300 ${
