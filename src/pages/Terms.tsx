            ...
            <div className="prose prose-invert max-w-none space-y-8">
              <div className="card-hover p-8 rounded-2xl bg-card border border-border">
                ...
                <div className="space-y-4 text-muted-foreground">
                  <p>By accessing and using Langlytics AI solutions, you accept and agree to be bound by the terms and provision of this agreement. These terms are governed by the laws of India, including the Information Technology Act, 2000 and the Consumer Protection Act, 2019.</p>
