            ...
            <div className="prose prose-invert max-w-none space-y-8">
              ...
              <div className="card-hover p-8 rounded-2xl bg-card border border-border">
                ...
                <div className="space-y-4 text-muted-foreground">
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    ...
                    <li>Complying with legal obligations under Indian data protection laws</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="card-hover p-8 rounded-2xl bg-card border border-border">
                ...
                <div className="space-y-4 text-muted-foreground">
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    ...
                    <li>We comply with the Information Technology Act, 2000 and IT Rules 2011</li>
              ...
              <div className="card-hover p-8 rounded-2xl bg-card border border-border">
                ...
                <div className="space-y-4 text-muted-foreground">
                  ...
                  <p className="mt-4">To exercise these rights, contact us at <a href="mailto:privacy@langlytics.ai" className="text-primary hover:underline">privacy@langlytics.ai</a></p>
                </div>
              </div>
              ...
              <div className="card-hover p-8 rounded-2xl bg-card border border-border">
                ...
                <div className="text-muted-foreground">
                  ...
                  <div className="mt-4 space-y-2">
                    <p><strong>Email:</strong> privacy@langlytics.ai</p>
