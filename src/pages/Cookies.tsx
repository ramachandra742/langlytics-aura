            ...
            <div className="prose prose-invert max-w-none space-y-8">
              <div className="card-hover p-8 rounded-2xl bg-card border border-border">
                ...
                <div className="space-y-4 text-muted-foreground">
                  ...
                  <p>We use cookies in compliance with the Information Technology (Reasonable Security Practices and Procedures and Sensitive Personal Data or Information) Rules, 2011.</p>
                </div>
              </div>
              ...
              <div className="card-hover p-8 rounded-2xl bg-card border border-border">
                ...
                <div className="space-y-4 text-muted-foreground">
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    <li>How users interact with our AI companions</li>
                    <li>Most frequently used features in ChatMyDocs</li>
                    <li>Technical performance of our AI models</li>
