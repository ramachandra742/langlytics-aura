                ...
                <div className="space-y-4 text-muted-foreground">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h3 className="font-semibold text-foreground">Information Technology Act, 2000</h3>
                        <p className="text-sm">Full compliance with digital governance and cyber security provisions</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <CheckCircle className="w-5 h-5 text-primary mt-1 flex-shrink-0" />
                      <div>
                        <h3 className="font-semibold text-foreground">IT Rules 2011 & 2021</h3>
                        <p className="text-sm">Adherence to data protection and intermediary guidelines</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <CheckCircle className="w-5 h-5 text-primary mt-1 flex-shrink-0" />
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm">Digital Personal Data Protection compliance framework</p>
                      </div>
                    </div>
                  </div>
                </div>
